...
class lab_3_intro(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab 3 Intro", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab 3 Intro")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab_3_intro")
        ...
        self.center_freq = center_freq = 315100000
        ...
        self._rf_gain_range = Range(0, 55, 5, 35, 200)
...
def main(top_block_cls=lab_3_intro, options=None):
