...
class lab_3(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Lab 3", catch_exceptions=True)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 2000000, 1000, 0, 0)
    ...
    def set_working_samp_rate(self, working_samp_rate):
        ...
        self.qtgui_time_sink_x_0.set_samp_rate(self.working_samp_rate)
        self.qtgui_waterfall_sink_x_0_0.set_frequency_range(0, self.working_samp_rate)
